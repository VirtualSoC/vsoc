...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGetString){
    break;
}
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGetStringi){
    break;
}
...
glGetStringi(name, index, buffer);
...
glEGLImageTargetTexture2DOES(target, imageSize);
}
break;
...
case FUNID_glGenBuffers_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenBuffers_special){
    break;
}
...
d_glGenBuffers_special(opengl_context,n, buffers);
}
break;


case FUNID_glGenRenderbuffers_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenRenderbuffers_special){
    break;
}
...
d_glGenRenderbuffers_special(opengl_context,n, renderbuffers);
}
break;


case FUNID_glGenTextures_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenTextures_special){
    break;
}
...
d_glGenTextures_special(opengl_context,n, textures);
}
break;


case FUNID_glGenSamplers_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenSamplers_special){
    break;
}
...
d_glGenSamplers_special(opengl_context,count, samplers);
}
break;


case FUNID_glCreateProgram_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glCreateProgram_special){
    break;
}
...
d_glCreateProgram_special(opengl_context,program);
}
break;


case FUNID_glCreateShader_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glCreateShader_special){
    break;
}
...
d_glCreateShader_special(opengl_context,type, shader);
}
break;


case FUNID_glFenceSync_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glFenceSync_special){
    break;
}
...
d_glFenceSync_special(opengl_context,condition, flags, sync);
}
break;
...
case FUNID_glGenFramebuffers_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenFramebuffers_special){
    break;
}
...
d_glGenFramebuffers_special(opengl_context,n, framebuffers);
}
break;


case FUNID_glGenProgramPipelines_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenProgramPipelines_special){
    break;
}
...
d_glGenProgramPipelines_special(opengl_context,n, pipelines);
}
break;


case FUNID_glGenTransformFeedbacks_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenTransformFeedbacks_special){
    break;
}
...
d_glGenTransformFeedbacks_special(opengl_context,n, ids);
}
break;


case FUNID_glGenVertexArrays_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenVertexArrays_special){
    break;
}
...
d_glGenVertexArrays_special(opengl_context,n, arrays);
}
break;


case FUNID_glGenQueries_special:
...
int para_num=get_para_from_call(call,all_para,MAX_PARA_NUM);
if(para_num<PARA_NUM_MIN_glGenQueries_special){
    break;
}
...
d_glGenQueries_special(opengl_context,n, ids);
}
break;
