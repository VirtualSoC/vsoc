...
GLenum d_glCheckFramebufferStatus(void *context, GLenum target)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLenum)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLenum));
    return ret;
}
...
GLuint d_glCreateProgram(void *context)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLuint)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLuint));
    return ret;
}
...
GLboolean d_glIsBuffer(void *context, GLuint buffer)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    memcpy(&ret, &ret_long, sizeof(GLboolean));
    return ret;
}
...
GLint d_glGetAttribLocation(void *context, GLuint program, const GLchar *name)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLint)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLint));
    return ret;
}
...
{
    unsigned char *send_buf = (unsigned char *)malloc(32 + 16 + 16 * (0 + count));
...
GLbitfield d_glQueryMatrixxOES(void *context, GLfixed *mantissa, GLint *exponent)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLint) * 16;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)mantissa;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)sizeof(GLint) * 16;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)exponent;
    ptr += sizeof(uint64_t);
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    memcpy(&ret, &ret_long, sizeof(GLbitfield));
    return ret;
}
...
void d_glGenBuffers(void *context, GLsizei n, GLuint *buffers)
{
    ...
    *(uint64_t *)ptr = (uint64_t)n * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)buffers;
    ptr += sizeof(uint64_t);
...
void d_glGenFramebuffers(void *context, GLsizei n, GLuint *framebuffers)
{
    ...
    *(uint64_t *)ptr = (uint64_t)n * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)framebuffers;
    ptr += sizeof(uint64_t);
...
void d_glGenRenderbuffers(void *context, GLsizei n, GLuint *renderbuffers)
{
    ...
    *(uint64_t *)ptr = (uint64_t)n * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)renderbuffers;
    ptr += sizeof(uint64_t);
...
void d_glGenTextures(void *context, GLsizei n, GLuint *textures)
{
    ...
    *(uint64_t *)ptr = (uint64_t)n * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)textures;
    ptr += sizeof(uint64_t);
...
void d_glGetActiveAttrib(void *context, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLsizei);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)length;
    ptr += sizeof(uint64_t);
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLenum);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)type;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)bufSize;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)name;
    ptr += sizeof(uint64_t);
...
void d_glGetAttachedShaders(void *context, GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders)
{
    ...
    *(uint64_t *)ptr = (uint64_t)maxCount * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)shaders;
    ptr += sizeof(uint64_t);
...
void d_glGetBooleanv(void *context, GLenum pname, GLboolean *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLboolean);
    ptr += sizeof(uint64_t);
...
void d_glGetFloatv(void *context, GLenum pname, GLfloat *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLfloat);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)data;
    ptr += sizeof(uint64_t);
...
void d_glGetIntegerv(void *context, GLenum pname, GLint *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)data;
    ptr += sizeof(uint64_t);
...
void d_glGetShaderPrecisionFormat(void *context, GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision)
{
    ...
    *(uint64_t *)ptr = (uint64_t)2 * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)range;
    ptr += sizeof(uint64_t);
...
void d_glGetUniformfv(void *context, GLuint program, GLint location, GLfloat *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_get_program_uniform_size(context, program, location);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
{
    unsigned char *send_buf = (unsigned char *)malloc(32 + 16 + 16 * (1 + uniformCount));
    ...
    *(uint64_t *)ptr = (uint64_t)uniformCount * sizeof(GLuint);
    ptr += sizeof(uint64_t);
...
void d_glGetQueryObjectuiv(void *context, GLuint id, GLenum pname, GLuint *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
void d_glGetActiveUniformsiv(void *context, GLuint program, GLsizei uniformCount, const GLuint *uniformIndices, GLenum pname, GLint *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)uniformCount * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
void d_glGetActiveUniformBlockiv(void *context, GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_get_uniform_block_para_size(context, program, uniformBlockIndex, pname) * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
void d_glGetInteger64v(void *context, GLenum pname, GLint64 *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLint64);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)data;
    ptr += sizeof(uint64_t);
...
void d_glGetInteger64i_v(void *context, GLenum target, GLuint index, GLint64 *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLint64);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)data;
    ptr += sizeof(uint64_t);
...
void d_glGenSamplers(void *context, GLsizei count, GLuint *samplers)
{
    ...
    *(uint64_t *)ptr = (uint64_t)count * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)samplers;
    ptr += sizeof(uint64_t);
...
void d_glGetProgramBinary(void *context, GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, void *binary)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLenum);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)binaryFormat;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)bufSize;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)binary;
    ptr += sizeof(uint64_t);
...
void d_glGetInternalformativ(void *context, GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)count * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
void d_glGetClipPlanexOES(void *context, GLenum plane, GLfixed *equation)
{
    ...
    *(uint64_t *)ptr = (uint64_t)4 * sizeof(GLfixed);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)equation;
    ptr += sizeof(uint64_t);
...
void d_glGetFixedvOES(void *context, GLenum pname, GLfixed *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)gl_pname_size(pname) * sizeof(GLfixed);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
{
    unsigned char *send_buf = (unsigned char *)malloc(32 + 16 + 16 * (0 + count + 1));
    ...
    *(GLsizei *)ptr = count;
    ...
    ptr = send_buf;
    *(uint64_t *)ptr = FUNID_glShaderSource;
    ptr += sizeof(uint64_t);
    ...
    *(uint64_t *)ptr = (uint64_t)save_buf;
    ...
    for (int i = 0; i < count; i++)
    {
        *(uint64_t *)ptr = (uint64_t)strlen(string[i]) + 1;
        ptr += sizeof(uint64_t);
        *(uint64_t *)ptr = (uint64_t)string[i];
        ptr += sizeof(uint64_t);
    }

    *(uint64_t *)ptr = count * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)length;
    ptr += sizeof(uint64_t);
...
void d_glTransformFeedbackVaryings(void *context, GLuint program, GLsizei count, const GLchar *const *varyings, GLenum bufferMode)
{
    ...
    *(uint64_t *)ptr = (uint64_t)save_buf;
    ...
    for (int i = 0; i < count; i++)
    {
        *(uint64_t *)ptr = (uint64_t)strlen(varyings[i]) + 1;
        ptr += sizeof(uint64_t);
        *(uint64_t *)ptr = (uint64_t)varyings[i];
        ptr += sizeof(uint64_t);
    }
...
void d_glGetProgramResourceiv(void *context, GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei bufSize, GLsizei *length, GLint *params)
{
    ...
    *(uint64_t *)ptr = (uint64_t)bufSize * sizeof(GLint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)params;
    ptr += sizeof(uint64_t);
...
void d_glGenProgramPipelines(void *context, GLsizei n, GLuint *pipelines)
{
    ...
    *(uint64_t *)ptr = (uint64_t)n * sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)pipelines;
    ptr += sizeof(uint64_t);
...
void d_glGetBooleani_v(void *context, GLenum target, GLuint index, GLboolean *data)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLboolean);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)data;
    ptr += sizeof(uint64_t);
...
GLsync d_glFenceSync(void *context, GLenum condition, GLbitfield flags)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLsync)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLsync));
    return ret;
}
...
void d_glTexImage2D_without_bound(void *context, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *pixels)
{
    ...
    *(uint64_t *)ptr = gl_pixel_data_size(context, width, height, format, type, 0);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)pixels;
    ptr += sizeof(uint64_t);
...
void d_glDrawRangeElements_without_bound(void *context, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices)
{
    ...
    *(uint64_t *)ptr = count * gl_sizeof(type);
    ptr += sizeof(uint64_t);
...
void d_glTexImage3D_without_bound(void *context, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels)
{
    ...
    *(uint64_t *)ptr = gl_pixel_data_3d_size(context, width, height, depth, format, type, 0);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)pixels;
    ptr += sizeof(uint64_t);
...
GLint64 d_glTestInt3(void *context, GLint64 a, GLuint64 b)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLint64)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLint64));
    return ret;
}
...
GLuint64 d_glTestInt4(void *context, GLint64 a, GLuint64 b)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLuint64)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLuint64));
    return ret;
}
...
GLfloat d_glTestInt5(void *context, GLint a, GLuint b)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLfloat)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLfloat));
    return ret;
}
...
GLdouble d_glTestInt6(void *context, GLint a, GLuint b)
{
    ...
    *(uint64_t *)ptr = (uint64_t)&ret_long;
    ...
    //ret =(GLdouble)ret_long;
    memcpy(&ret, &ret_long, sizeof(GLdouble));
    return ret;
}
...
void d_glTestPointer2(void *context, GLint a, const GLint *b, GLint *c)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLint) * 10;
    ptr += sizeof(uint64_t);
...
GLint d_glTestPointer3(void *context, GLint a, const GLint *b, GLint *c)
{
    ...
    *(uint64_t *)ptr = sizeof(GLint) * 20000;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)b;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)sizeof(GLint) * 20000;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)c;
    ptr += sizeof(uint64_t);
...
GLint d_glTestPointer4(void *context, GLint a, const GLint *b, GLint *c)
{
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLint) * 1000;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)c;
    ptr += sizeof(uint64_t);
...
{
    unsigned char *send_buf = (unsigned char *)malloc(32 + 16 + 16 * (1 + count));
    size_t send_buf_len = 32 + 16 * (1 + count);
    size_t para_num = 1 + 1 + count;
    unsigned char *ptr = NULL;
    ...
    *(uint64_t *)ptr = (uint64_t)buf_len;
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)char_buf;
    ptr += sizeof(uint64_t);
...
void d_glPrintf(void *context, GLint buf_len, GLchar *out_string)
{
    unsigned char send_buf[32 + 16 + 1 * 16];
    size_t send_buf_len = 32 + 1 * 16;
    size_t para_num = 1 + 1;
...
void d_glInOutTest(void *context, GLint a, GLint b, const GLchar *e, GLint *c, GLdouble *d, GLsizei buf_len, GLchar *f)
{
    ...
    *(GLsizei *)ptr = buf_len;
    ...
    ptr = send_buf;
    *(uint64_t *)ptr = FUNID_glInOutTest;
    ptr += sizeof(uint64_t);
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLdouble);
    ptr += sizeof(uint64_t);
...
void d_glDrawElements_without_bound(void *context, GLenum mode, GLsizei count, GLenum type, const void *indices)
{
    ...
    size_t indices_len = count * gl_sizeof(type);
    save_buf_len += indices_len;
    ...
    *(GLenum *)ptr = type;
    ...
    memcpy(ptr, (unsigned char *)indices, indices_len);
    ptr += indices_len;
...
void d_glFlushMappedBufferRange_origin(void *context, GLenum target, GLintptr offset, GLsizeiptr length)
{
    ...
    *(uint64_t *)ptr = FUNID_glFlushMappedBufferRange_origin;
    ptr += sizeof(uint64_t);
    if (save_buf_len == 0)
    {
        *(uint64_t *)ptr = 0;
...
void d_glVertexAttribPointer_data(void *context, GLuint length, const void *int_data, const void *pointer)
{
    unsigned char send_buf[32 + 2 * 16];
    size_t send_buf_len = 32 + 2 * 16;

    unsigned char *ptr = send_buf;

    *(uint64_t *)ptr = FUNID_glVertexAttribPointer_data;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = 2;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)sizeof(GLuint) + sizeof(GLuint);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)int_data;
    ptr += sizeof(uint64_t);
...
void d_glVertexAttribIPointer_data(void *context, GLuint length, const void *int_data, const void *pointer)
{
    unsigned char send_buf[32 + 2 * 16];
    size_t send_buf_len = 32 + 2 * 16;
    ...
    *(uint64_t *)ptr = FUNID_glVertexAttribIPointer_data;
    ptr += sizeof(uint64_t);
...
void d_glMapBufferRange_write(void *context, GLsizeiptr length, const void *int_data, const void *mem_buf)
{
    unsigned char send_buf[32 + 2 * 16];
    size_t send_buf_len = 32 + 2 * 16;
    ...
    *(uint64_t *)ptr = (uint64_t)sizeof(GLenum) + sizeof(GLintptr) + sizeof(GLsizeiptr) + sizeof(GLbitfield);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)int_data;
    ptr += sizeof(uint64_t);
...
void d_glSaveLongTime(void *context, GLuint a, const void *int_data, const void *pointer)
{
    unsigned char send_buf[32 + 2 * 16];
    size_t send_buf_len = 32 + 2 * 16;
    ...
    *(uint64_t *)ptr = FUNID_glSaveLongTime;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = 2;
    ptr += sizeof(uint64_t);

    *(uint64_t *)ptr = (uint64_t)sizeof(GLuint) + sizeof(GLdouble);
    ptr += sizeof(uint64_t);
    *(uint64_t *)ptr = (uint64_t)int_data;
    ptr += sizeof(uint64_t);
