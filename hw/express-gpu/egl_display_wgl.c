...
//     }
    ...
    // 循环逐个获取配置
    // LOGI("number format %d",num_formats);
...
//     // LOGI("rgba %d%d%d%d depth %d stencil %d",pfd->cRedBits,pfd->cGreenBits,pfd->cBlueBits,pfd->cAlphaBits,pfd->cDepthBits,pfd->cStencilBits);
