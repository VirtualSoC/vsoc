...
def arg_pack(arg):
    ...
    #     return f"(GLuint)get_host_buffer_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="framebuffer" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_framebuffer_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="program" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_program_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="renderbuffer" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_renderbuffer_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="shader" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_shader_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="texture" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_texture_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="id" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_query_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="array" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_array_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="sampler" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_sampler_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="feedback_id" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_feedback_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="sync" and arg['type']=="GLsync":
    #     return f"(GLsync)get_host_sync_id(egl_context,(unsigned int){arg['name']})"
    # elif arg['name']=="pipeline" and arg['type']=="GLuint":
    #     return f"(GLuint)get_host_pipeline_id(egl_context,(unsigned int){arg['name']})"
    # else:
    #     return f"{arg['name']}"
    return f"{arg['name']}"
...
def gen_qemu_asyn_copy(opengl_fun, out_file,is_special):
    ...
    # else:
    call_str = f"d_{opengl_fun.name}(egl_context"

    for arg in opengl_fun.args:
        if opengl_fun.type%100==10:
            if arg['ptr']=='out':
                call_str += f", NULL"
            else:
                call_str += f", {arg['name']}"
