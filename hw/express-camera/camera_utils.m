...
void listAvfoundationDevices(AVDeviceInfoList *deviceList) {
    //printf("in listAvfoundationDevices()\n");
    ...
    //AVDeviceInfoList *deviceList = av_mallocz(sizeof(AVDeviceInfoList));
    //deviceList = av_mallocz(sizeof(AVDeviceInfoList));
    //for (AVCaptureDevice *device in devices) {
        LOGI("Device Name: %s %s\n", [device.localizedName UTF8String],[device.uniqueID UTF8String]);
        ...
        info->device_name = [device.localizedName UTF8String];
