...
#include "hw/vsoc/sensor/express_gyro.h"
...
static void gyro_buffer_register(Guest_Mem *data, uint64_t thread_id, uint64_t process_id, uint64_t unique_id, uint64_t user_id, Express_Device_Info *info)
{
