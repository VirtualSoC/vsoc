...
#include "hw/vsoc/sensor/express_mic.h"
...
#include "hw/vsoc/sensor/miniaudio.h"
#include <sys/time.h>
...
static void mic_buffer_register(Guest_Mem *data, uint64_t thread_id, uint64_t process_id, uint64_t unique_id, uint64_t user_id, Express_Device_Info *info)
{
