...
static Property teleport_express_base_properties[] = {
    ...
    DEFINE_PROP_BOOL("show_device_input_window", Teleport_Express_PCI, show_device_input_window, false),
    ...
    DEFINE_PROP_INT32("touchscreen_width", Teleport_Express_PCI, touchscreen_width, 1920),
    DEFINE_PROP_INT32("touchscreen_height", Teleport_Express_PCI, touchscreen_height, 1080),
...
static void teleport_express_pci_realize(VirtIOPCIProxy *vpci_dev, Error **errp)
{
    ...
    express_device_input_window = express_pci->show_device_input_window;
    ...
    express_touchscreen_size[0] = express_pci->touchscreen_width;
    express_touchscreen_size[1] = express_pci->touchscreen_height;
