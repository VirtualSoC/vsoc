...
static void teleport_express_pci_realize(VirtIOPCIProxy *vpci_dev, Error **errp)
{
    ...
    express_gpu_enable_windowed_mode = express_pci->enable_windowed_mode;
    ...
    express_display_count = express_pci->display_count;
    express_display_options = express_pci->display_options;
    ...
    express_display_headless_mode = express_pci->headless_mode;
